...
const SVC_URL = "https://appadaycreator.com/study-method-advisor/";
const SVC_NAME = "学習スタイル診断";

test.describe("学習スタイル診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("study-method-advisor");
